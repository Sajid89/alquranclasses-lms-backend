...
class TeacherPreviousClassesProcedure extends Migration
{
    /**
     * Run the migrations.
     * previous trial classes
     *
     * @return void
     */
    public function up()
    {
        try {
            $deleteProcedure = "DROP procedure IF EXISTS spTeacherPreviousTrialClasses;";

            $procedure = "
            CREATE PROCEDURE spTeacherPreviousTrialClasses(IN teacherId INT, IN classTime DATETIME, IN page INT, IN recordsLimit INT) 
