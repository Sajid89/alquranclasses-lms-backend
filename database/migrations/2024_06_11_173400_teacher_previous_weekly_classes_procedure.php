...
class TeacherPreviousWeeklyClassesProcedure extends Migration
{
    /**
     * Run the migrations.
    ...
    {
        try {
            $deleteProcedure = "DROP procedure IF EXISTS spTeacherPreviousWeeklyClasses;";

            $procedure = "
            CREATE PROCEDURE spTeacherPreviousWeeklyClasses(IN teacherId INT, IN classTime DATETIME, IN page INT, IN recordsLimit INT) 
