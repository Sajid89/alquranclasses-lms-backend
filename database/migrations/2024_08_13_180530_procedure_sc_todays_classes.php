...
class ProcedureScTodaysClasses extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        try {
        $deleteProcedure = "DROP procedure IF EXISTS spTeachersTodaysClasses;";

            $procedure = "
            CREATE PROCEDURE spTeachersTodaysClasses(IN teacherCoordinatorId INT, IN todayDate VARCHAR(11), IN page INT, IN recordsLimit INT) 
