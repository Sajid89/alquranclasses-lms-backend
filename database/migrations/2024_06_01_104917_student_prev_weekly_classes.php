...
class StudentPrevWeeklyClasses extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        try {
            $deleteProcedure = "DROP procedure IF EXISTS spPreviousWeeklyClasses;";

            $procedure = "
            CREATE PROCEDURE spPreviousWeeklyClasses(IN studentId INT, IN classTime DATETIME, IN page INT, IN recordsLimit INT) 
            ...
            `u`.`id` as `teacher_id`, `u`.`name` as `teacher_name`, `wc`.`id` as `tw_class_id`, 
