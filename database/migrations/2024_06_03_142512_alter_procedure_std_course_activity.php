...
class AlterProcedureStdCourseActivity extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        BEGIN
            select `s`.`name` as `student_name`, `s`.`timezone` as `student_time_zone`,
            `u`.`name` as `teacher_name`, `u`.`timezone` as `teacher_time_zone`,
