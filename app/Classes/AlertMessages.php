...
class AlertMessages{
    ...
    public const TEACHER_ASSIGNED_CONFLICT = 'Your selected slot already assigned. Please select different slot!';
    ...
    public const RESOURCE_MESSAGE = "Directory Updated Successfully";
}
